...
export function playSound (track) {
  const soundMap = {
    click: require('../audio/click-song.mp3'),
    bust: require('../audio/lose.mp3'),
    lose: require('../audio/lose.mp3'),
    win: require('../audio/win.mp3'),
    blackjack: require('../audio/win.mp3'),
    error: require('../audio/error.mp3'),
    push: require('../audio/error.mp3')
  };
  const sound = soundMap[track];
